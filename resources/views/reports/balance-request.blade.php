...
@enderror
<form class="row g-2" action="{{ route('reports.balance-request-download') }}" method="post" id="balance-form">
    @csrf
    <div class="col-4">
    ...
    <div class="col-4">
        ...
        <input type="text" class="form-control" id="account-number" name="account_number" placeholder="62500000065500">
    </div>
    <div class="col-4">
        <label for="account-name" class="form-label">Account Name</label>
        <input type="text" class="form-control" id="account-name" name="account_name" placeholder="التوزيع الحديث التجارية">
    </div>
    <div class="col-md-4">
        <label for="rep_id" class="form-label"> Representative ID </label>
        <input type="text" class="form-control" id="rep_id" name="rep_id" placeholder="MDR0040" value="{{ old('rep_id') }}">
    </div>
    <div class="col-md-4">
